...
export const login = async (req, res) => {
  ...
  try {
    ...
    res.cookie("accessToken", token, { httpOnly: true, sameSite: 'None', secure: true /*process.env.NODE_ENV === "production" || false,*/ }).status(200).send({ success: true, message: "user login successfully", info })
  } catch (error) {
